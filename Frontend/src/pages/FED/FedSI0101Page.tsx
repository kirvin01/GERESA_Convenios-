      ...
      <Box display="flex" alignItems="center" gap={1.5} mb={1}>
        ...
        <Box>
          ...
          <Typography color="text.secondary">
            Condición previa (CP): Porcentaje de gestantes atendidas en establecimientos de salud del Gobierno Regional, que reciben su primera atención prenatal en el primer trimestre de gestación.
          </Typography>
        </Box>
      </Box>
      <Divider sx={{ mb: 3 }} />
