      ...
      <Box display="flex" alignItems="center" gap={1.5} mb={1}>
        ...
        <Box>
          ...
          <Typography color="text.secondary">
            Condición previa (CP): Porcentaje de niñas y niños de seis (06) meses de edad, del departamento, que a los cuatro (04) meses de edad reciben suplementación preventiva con hierro, y dosaje de hemoglobina.
          </Typography>
        </Box>
      </Box>
      <Divider sx={{ mb: 3 }} />
