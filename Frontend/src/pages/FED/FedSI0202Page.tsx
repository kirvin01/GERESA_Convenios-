      ...
      <Box display="flex" alignItems="center" gap={1.5} mb={1}>
        ...
        <Box>
          ...
          <Typography color="text.secondary">
            Porcentaje de niñas y niños de seis (06) meses de edad, prematuros y/o bajo peso al nacer, del departamento, sin anemia; que reciben suplementación preventiva con hierro y dosajes de hemoglobina.
          </Typography>
        </Box>
      </Box>
      <Divider sx={{ mb: 3 }} />
