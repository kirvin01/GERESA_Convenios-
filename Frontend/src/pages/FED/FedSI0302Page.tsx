// src/components/ReportesSI0302.tsx
...
import {
  ...
  type ResumenRow,
} from '../../services/servicesFED/fedSI0302Service';
...
export function FedSI0302Page() {
  ...
  useEffect(() => {
    ...
    fedSI0302Service.getFiltros(ctrl.signal)
      .then((data) => {
        setFiltros(data);
  ...
  const cargarTablaCompleta = useCallback((signal?: AbortSignal) => {
    ...
    fedSI0302Service.getTablaCompleta(
  ...
  const cargarTablaRedes = useCallback((signal?: AbortSignal) => {
    ...
    setLoadingTabla(true);
    setNotification(null);
    fedSI0302Service.getTablaRedes(
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 3, mb: 4 }}>
      ...
      <Box display="flex" alignItems="center" gap={1.5} mb={1}>
        ...
        <Box>
          <Typography variant="h4" fontWeight={700}>FED SI-03.02</Typography>
          <Typography color="text.secondary">
            Porcentaje de gestantes que recibieron suplementación con micronutrientes, consejería nutricional y dosaje de hemoglobina en el tercer trimestre.
          </Typography>
        </Box>
      </Box>
      <Divider sx={{ mb: 3 }} />
