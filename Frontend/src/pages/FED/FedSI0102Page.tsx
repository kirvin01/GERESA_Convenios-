  ...
  return (
    <>
      ...
      >
        ...
        <Typography variant="body2" fontWeight={700} sx={{ color: COLOR_PRIMARIO }}>{prov.DEPARTAMENTO}</Typography>
        <Typography variant="body2" fontWeight={700} sx={{ color: COLOR_PRIMARIO }}>Total {prov.PROVINCIA}</Typography>
            ...
            <Box display="flex" gap={1}>
              {(['jerarquica', 'plana'] as const).map((v) => (
                <Chip key={v}
                  ...
                  color={vista === v ? 'primary' : 'default'}
                  onClick={() => setVista(v)}
                  sx={{
                    cursor: 'pointer',
                    bgcolor: vista === v
                      ? (modoVista === 'territorial' ? COLOR_PRIMARIO : COLOR_SECUNDARIO)
                      : 'transparent',
                    color: vista === v ? '#fff' : 'text.primary',
                    border: vista === v
                      ? 'none'
