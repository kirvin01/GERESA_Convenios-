// src/services/servicesFED/fedSI0302Service.ts
// Servicio para el reporte FED SI-03.02

import { API_CONFIG } from '../../config';
import { authHeader } from '../authService';

const BASE = `${API_CONFIG.baseURL}/fed/si0302`;
